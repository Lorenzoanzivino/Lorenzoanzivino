...
* **Qualità & Testing:** Piramide dei test completa (Mockito, H2 Database, MockMvc).
...
* **Focus:** Motore di workout JSON-based, gestione stato e progressi utente, logica offline-first, gamification.
...
#### 🎮 [MobileGame](https://github.com/Lorenzoanzivino/MobileGame)
